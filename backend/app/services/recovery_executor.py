...
class RecoveryExecutor:
    ...
    def execute_recovery(
        ...
        if existing_record:
            ...
            return {
                ...
                "decision": {
                    ...
                    "confidence": existing_record.get("strategy_confidence", decision.get("strategy_confidence", 1.0)),
                    "predicted_recovery_probability": existing_record.get("predicted_recovery_probability", predicted_prob),
                    "expected_recovery_value": existing_record.get("expected_recovery_value", round(amount * predicted_prob, 2)),
                    "reason_codes": existing_record.get("reason_codes", decision.get("reason_codes", [])),
                },
                "policy": {
        ...
        store_data = {
            ...
            "strategy_confidence": float(decision.get("strategy_confidence", 0.0)),
            "predicted_recovery_probability": float(predicted_prob),
            "expected_recovery_value": round(amount * predicted_prob, 2),
            "reason_codes": all_reason_codes,
